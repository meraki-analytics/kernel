...
def summoners_by_name(region, summonerNames):
    ...
    if missing:
        ...
        new_summoners = merakikernel.requests.get(region, url, dict(bottle.request.query))
...
def summoner_masteries(region, summonerIds):
    ...
    if missing:
        ...
        new_masteries = merakikernel.requests.get(region, url, dict(bottle.request.query))
