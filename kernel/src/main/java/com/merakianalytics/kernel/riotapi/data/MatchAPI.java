...
public class MatchAPI extends RiotAPIService {
     ...
     * @param matchId
     *        the match's id
     * @return {@link com.merakianalytics.orianna.types.data.match.Match}
     */
     ...
     * @param tournamentCode
     *        the tournament code
     * @return {@link com.merakianalytics.orianna.types.data.match.TournamentMatches}
     */
     ...
     * @return {@link com.merakianalytics.orianna.types.data.match.MatchList}
     */
     ...
     * @param matchId
     *        the match's id
     * @return {@link com.merakianalytics.orianna.types.data.match.Timeline}
     */
    @Path("/timelines/by-match/{matchId}")
    @GET
    public Timeline getMatchTimeline(@QueryParam("platform") final String platformTag, @PathParam("matchId") final long matchId) {
        final Platform platform = platformTag != null ? Platform.withTag(platformTag) : context.getDefaultPlatform();
        if(platform == null) {
        ...
        return context.getPipeline().get(Timeline.class, query);
    }
}
