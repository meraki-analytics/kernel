...
@bottle.route("/api/lol/championmastery/location/<platformId>/player/<summonerId>/champion/<championId>", method=["GET", "OPTIONS"])
...
@bottle.route("/api/lol/championmastery/location/<platformId>/player/<summonerId>/champions", method=["GET", "OPTIONS"])
@merakikernel.common.riot_endpoint
...
@bottle.route("/api/lol/championmastery/location/<platformId>/player/<summonerId>/score", method=["GET", "OPTIONS"])
@merakikernel.common.riot_endpoint
...
@bottle.route("/api/lol/championmastery/location/{platformId}/player/{summonerId}/topchampions", method=["GET", "OPTIONS"])
@merakikernel.common.riot_endpoint
