...
public class LeagueAPI extends RiotAPIService {
    ...
    @GET
    public League getChallengerLeague(@QueryParam("platform") final String platformTag, @PathParam("queue") final String queueTag) {
    ...
    @GET
    public League getGrandmasterLeague(@QueryParam("platform") final String platformTag, @PathParam("queue") final String queueTag) {
        final Platform platform = platformTag != null ? Platform.withTag(platformTag.toUpperCase()) : context.getDefaultPlatform();
        if(platform == null) {
            throw new WebApplicationException(platformTag + " is not a valid platform!", HttpURLConnection.HTTP_BAD_REQUEST);
        }
    ...
    @GET
    public League getMasterLeague(@QueryParam("platform") final String platformTag, @PathParam("queue") final String queueTag) {
        final Platform platform = platformTag != null ? Platform.withTag(platformTag.toUpperCase()) : context.getDefaultPlatform();
        if(platform == null) {
            throw new WebApplicationException(platformTag + " is not a valid platform!", HttpURLConnection.HTTP_BAD_REQUEST);
        }
